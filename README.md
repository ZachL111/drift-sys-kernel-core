...
drift-sys-kernel-core is a R project for systems programming. It focuses on this technical goal: Build an R toolkit that studies kernel behavior through bounded scenario files, with conflict explanations and no credentials or hosted services.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 162, risk penalty 6, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
