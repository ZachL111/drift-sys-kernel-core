...
$repo = "drift-sys-kernel-core"
$language = "R"
$category = "Systems programming"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/drift-sys-kernel-walkthrough.md")) {
